...
---------------------
Let's create a new **01.mongo.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **01.mongo.js** file.

```
node 01.mongo.js
```

You should see the following output after running the **01.mongo.js** file.
